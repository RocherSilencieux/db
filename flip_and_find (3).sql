...
--
-- Hôte : 127.0.0.1
-- Généré le : mer. 04 déc. 2024 à 14:02
...
(270, 1, 15, 'coucou', '2024-11-15 09:56:19'),
(271, 1, 15, '123', '2024-11-15 10:00:20'),
(272, 1, 16, 'desfgnvgdsf', '2024-11-15 10:02:53'),
(273, 1, 22, 'sfh', '2024-12-04 11:06:01'),
(274, 1, 22, 'fgh;b,njhghgd', '2024-12-04 11:06:10');
...
CREATE TABLE `score` (
  ...
  `id_jeu` int(11) NOT NULL DEFAULT 1,
...
(94, 22, 1, 'Moyen', 93, '2024-12-04 11:22:27', 'Meme');
...
(22, 'goldengame999@gmail.com', '$2y$10$2hnxkydcdWkdzB78OCvoWuOXbiYvOP3Uh0ZeXw28V3dsFvADaL8tS', 'nino', '2024-12-04 11:05:38', '2024-12-04 11:05:38', 0, 16, 100);
...
--
ALTER TABLE `message`
  MODIFY `identifiant` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=275;
...
--
ALTER TABLE `score`
  MODIFY `identifiant` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=95;

--
-- AUTO_INCREMENT pour la table `utilisateur`
--
ALTER TABLE `utilisateur`
  MODIFY `identifiant` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
